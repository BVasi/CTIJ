...
public class WaveManager : MonoBehaviour
{
    ...
    {
        enemy.GetComponent<EnemyStats>().IncreaseDamage((int)Mathf.Ceil(_currentWave * DIFFICULTY_MULTIPLIER));
        enemy.GetComponent<EnemyStats>().IncreaseHealth((int)Mathf.Ceil(_currentWave * DIFFICULTY_MULTIPLIER));
        if (IsBossWave())
        {
